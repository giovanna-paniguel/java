...
/** Esta classe Termometro é a resolução do 1o exercício da Lista de Reforço
 *  Neste caso, essa classe não está encapsulada
 *
...
public class Termometro {
    ...
    // Atributos
    Double temperaturaAtual;            // temperatura atual registrada pelo termômetro
    Double temperaturaMaxRegistrada;    // temperatura máxima registrada até o momento
    Double temperaturaMinRegistrada;    // temperatura mínima registrada até o momento
